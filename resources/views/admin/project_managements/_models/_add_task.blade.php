      ...
      <div class="modal-dialog modal-lg">
          <div class="modal-content">
              <div class="modal-header bg-danger">
                  <h5 class="modal-title text-white" id="taskAddLabel">Add Task</h5>
                  <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                  </button>
              </div>
              <div class="modal-body">
                  <form id="addMemberForm" method="POST" action="{{ route('task.store') }}">
                      ...
                      <div class="form-row">
                          <div class="form-group col-md-3">
                              ...
                              <input type="number" value="{{ $taskNumber }}" readonly class="form-control">
                          </div>
                          <div class="form-group col-md-3">
                              <div class="d-flex justify-content-between">
                      ...
                      <div class="form-row">
                          ...
                          <div class="form-group col-12 col-md-6 text-right">
                              ...
                              <textarea name="task_description_arabic" type="text" class="form-control" id="task_description_arabic"
                      ...
                      <div class="form-row">
                          ...
                          <div class="col-12 col-md-6">
                              ...
                              <div class="form-group col-12">
                                  <select name="member_id[]" id="member_id" class="form-control" multiple>
                                      {{--  <option value="">Choose</option>  --}}
              ...
              <div class="modal-footer">
                  ...
                  <button type="button" class="btn save-btn d-flex" id="addMemberBtn">
                      <p>Save &nbsp;/&nbsp;</p>
