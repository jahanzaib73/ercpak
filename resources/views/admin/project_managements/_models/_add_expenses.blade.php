         ...
         <div class="modal-content">
             <div class="modal-header bg-danger">
                 <div class="d-flex justify-content-between">
                     <h5 class="modal-title text-white" id="projectModalLabel">Add Expense &nbsp; / &nbsp;</h5>
             ...
             <div class="modal-footer">
                 ...
                 <button <button type="button" class="btn save-btn d-flex" data-dismiss="modal">
                     <p>Close &nbsp;/&nbsp;</p>
                     <p class="arabic">يغلق</p>
                 </button>
                 <button type="button" class="btn save-btn d-flex" id="addExpenseBtn">
                     <p>Save &nbsp;/&nbsp;</p>
