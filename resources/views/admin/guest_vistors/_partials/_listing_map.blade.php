        ...
        <div class="card card-custom active">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="text-end">
                    ...
                    <br>
                    <br>
                    <div class="total-guests text-right">{{ $allstate }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="card card-custom">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="text-end">
                    ...
                    <br>
                    <br>
                    <div class="total-guests text-right">{{ $baluchistanVisitor }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="card card-custom">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="text-end">
                    ...
                    <br>
                    <br>
                    <div class="total-guests text-right">{{ $khyberVisitor }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="card card-custom">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="text-end">
                    ...
                    <br>
                    <br>
                    <div class="total-guests text-right">{{ $punjabVisitor }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="card card-custom">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="text-end">
                    ...
                    <br>
                    <br>
                    <div class="total-guests text-right">{{ $sindhVisitor }}</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <ul class="nav nav-pills mb-3 float-end" id="listing-pills-tab" role="tablist">
        <li class="nav-item mb-2" role="presentation">
            <button class="nav-link active btn btn-outline-danger mr-2" id="pills-home-tab" data-toggle="pill"
                data-target="#pills-home" data-name="Pakistan" type="button" role="tab" aria-controls="pills-home"
                aria-selected="true">Pakistan</button>
        </li>
        <li class="nav-item mb-2" role="presentation">
        ...
        <li class="nav-item mb-2" role="presentation">
            <button class="nav-link btn btn-outline-danger mr-2" id="pills-contact-tab" data-toggle="pill"
                data-target="#pills-contact" data-name="sindh" type="button" role="tab"
    ...
    <div class="col-9">
        <div class="tab-content" id="pills-tabContent">
            ...
            <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-12 col-md-12">
                                                <svg id="listing_map" xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    viewBox="500 950 828 644" style="display: inline;">
                                                    ...
                                                    <g class="model-green" id="Sindh" fill="#ffffd0"
                                                        ...
                                                        <a id="state_Tando_Allah_Yar" class="state"
                                                            xlink:href="">
                                                            <path id="Tando_Allah_Yar" class="shape"
                                                                d="m 821.2,1336 -10,9 0.6,10 -6.4,9.8 3.2,13.6 -4.4,5.8 3.8,5.8 5.4,-0.2 0.8,5.8 18.8,0 6.2,-9.4 0.6,-13 -6.8,-13.6 0.6,-18.4 z" />
                                                        </a>
                                                        ...
                                                        <a id="state_Qambar_Shahdatkot" class="state"
                                                            xlink:href="">
                                                            <path id="Qambar_Shahdatkot" class="shape"
                                                                d="m 662.6,1124.7 -9.6,29.2 94.8,7.2 7.2,-9 -1,-12.4 8.4,-22.6 8.6,-19 -5.6,-3.4 -3,-10.8 -8.8,-5.2 -12.2,0 -9.4,-5 -26,11.4 -27.6,6 z" />
                                                        </a>
                                                        ...
                                                        <a id="state_Naushahro_Firoze" class="state"
                                                            xlink:href="">
                                                            <path id="Naushahro_Firoze" class="shape"
                                                                d="m 729.8,1210.8 5.6,22.2 -6,6.6 10,7.6 10.6,-7 27.8,-5.2 2,-29.6 9.8,-27.1 -24.2,-12.8 -12.8,13.8 -10.2,6.6 3.4,10 z" />
                                                        </a>
                                                        ...
                                                        <a id="state_Khairpur_Mir's" class="state"
                                                            xlink:href="">
                                                            <path id="Khairpur" class="shape"
                                                                d="m 765.4,1165.5 24.2,12.8 -9.8,27.1 -2,29.6 40.2,2.6 15.8,17.2 23.6,26.4 90.4,17.8 9.2,-21.6 -0.4,-35 -10.2,-5.6 -18.6,2 -39,-21 2.2,-28.7 -43.2,-20 -17.6,-14.4 5.4,-15.6 -9.2,-6.8 6.2,-19.4 -12,0 -8.8,-6.2 -18.8,5.8 5.4,6.6 -16.2,3.6 -8.2,12.8 8.2,14.8 -9.2,1.8 z" />
                                                        </a>
                ...
                <!-- =========KPK======== -->
                <div class="tab-pane fade" id="pills-contacta" role="tabpanel"
                    aria-labelledby="pills-contacta-tab">
                    <div class="row">
                        <div class="col-9">
                            <div class="row justify-content-center">
                                <div class="col-12 col-md-12">
