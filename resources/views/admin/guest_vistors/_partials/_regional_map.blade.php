<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
    <li class="nav-item mb-2" role="presentation">
        <button class="nav-link active btn btn-outline-danger mr-2" id="pills-home-tab" data-toggle="pill"
    ...
    <li class="nav-item mb-2" role="presentation">
        <button class="nav-link btn btn-outline-danger mr-2" id="pills-profile-tab" data-toggle="pill"
    ...
    <li class="nav-item mb-2" role="presentation">
        <button class="nav-link btn btn-outline-danger mr-2" id="pills-contact-tab" data-toggle="pill"
    ...
    <li class="nav-item mb-2" role="presentation">
        <button class="nav-link btn btn-outline-danger mr-2" id="pills-contacts-tab" data-toggle="pill"
    ...
    <li class="nav-item mb-2" role="presentation">
        <button class="nav-link btn btn-outline-danger mr-2" id="pills-contacta-tab" data-toggle="pill"
...
<div class="tab-content" id="pills-tabContent">
    ...
    <div class="tab-pane fade" id="pills-contacts" role="tabpanel" aria-labelledby="pills-contacts-tab">
        <div class="row">
            <div class="col-12">
                <svg id="regional_map" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    viewBox="800 300 1028 1244" style="display: inline;">
    ...
    <div class="tab-pane fade" id="pills-contacta" role="tabpanel" aria-labelledby="pills-contacta-tab">
        <div class="row">
            <div class="col-12">
                <svg id="regional_map" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    viewBox="600 0 828 744" style="display: inline;">
