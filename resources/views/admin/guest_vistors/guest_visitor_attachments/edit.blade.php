...
@section('content')
    <div class="container-fluid">
        <div class="page-head">
            <h4 class="mt-2 mb-2"><a href="{{ route('task-list.index', ['id' => $task->task_id]) }}">Task List</a> / Add List
            </h4>
        ...
        <form class="" method="post" action="{{ route('task-list.update', ['id' => $task->id]) }}"
                            ...
                            <div id="team_container">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="subject" class="form-control"
                                                value="{{ old('subject', $task->subject) }}" placeholder="subject" />
                                            @error('subject')
                                                <span class="error">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Notes</label>
                                            <textarea name="notes" id="notes" class="form-control" cols="30" rows="3">{{ old('notes', $task->notes) }}</textarea>
                                            @error('notes')
                                                <span class="error">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" class="form-control"
                                                value="{{ old('name', $task->file_name) }}" placeholder="Name" />
                                            @error('name')
                                                <span class="error">
                                                    <strong>{{ $message }}</strong>
                                                </span>
