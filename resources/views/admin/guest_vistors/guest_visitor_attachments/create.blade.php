...
@section('content')
    <div class="container-fluid">
        <div class="page-head">
            <h4 class="mt-2 mb-2"><a href="{{ route('guest-visitor-attachment.index', ['id' => $guestVisitId]) }}">Attachment
                    List</a> / Add
                List
            </h4>
        ...
        <form class="" method="post" action="{{ route('guest-visitor-attachment.store') }}"
