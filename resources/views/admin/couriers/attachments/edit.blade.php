...
@section('content')
    <div class="container-fluid">
        <div class="page-head">
            <h4 class="mt-2 mb-2"><a href="{{ route('courier-attachments.index', ['id' => $courier_id]) }}">Attachments</a>
        ...
        <form class="" method="post" action="{{ route('courier-attachments.update', ['id' => $attachment->id]) }}"
