                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right">
                                <a href="{{ route('flight-and-cargos.create', ['module' => 'record_by_road']) }}"
    ...
    <script>
        var table = $('.ajax-table').DataTable({
            ...
            columns: [{
                ...
                {
                    data: 'road_arrival_origin',
                    name: 'road_arrival_origin'
                },
                {
                    data: 'road_arrival_date_time',
                    name: 'road_arrival_date_time'
                },
                {
                    data: 'road_destination',
                    name: 'road_destination'
                },
                {
                    data: 'road_destination_date_time',
                    name: 'road_destination_date_time'
                },
                {
                    data: 'road_type_of_cargo',
                    name: 'road_type_of_cargo'
                },
                {
                    data: 'road_cargo_belongs_to',
                    name: 'road_cargo_belongs_to'
                },
