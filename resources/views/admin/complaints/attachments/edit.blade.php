...
@section('content')
    <div class="container-fluid">
        <div class="page-head">
            <h4 class="mt-2 mb-2"><a href="{{ route('complaint-attachments.index', ['id' => $complaint_id]) }}">Document
                    Attachments</a>
        ...
        <form class="" method="post" action="{{ route('complaint-attachments.update', ['id' => $attachment->id]) }}"
