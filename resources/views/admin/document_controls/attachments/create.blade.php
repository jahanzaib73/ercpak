...
@section('content')
    ...
    <div class="page-head">
        ...
        <form class="" method="post" action="{{ route('document-control-attachments.store') }}"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            {{-- <h6><strong>File Category</strong></h6> --}}
                                            <select class="form-control" name="certificate_name" id="certificate_name" style="width: 100%;">
                                                <option value="">Select Category</option>
                                                <option value="letter_received"
                                                    {{ old('certificate_name') == 'letter_received' ? 'selected' : '' }}>
                                                    Letters Received</option>
                                                <option value="issued_by_consulte"
                                                    {{ old('certificate_name') == 'issued_by_consulte' ? 'selected' : '' }}>
