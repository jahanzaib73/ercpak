    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            {{-- <div class="modal-header bg-danger">
                <h5 class="modal-title text-white" id="addRequestModalLabel">Add Request &nbsp; / &nbsp;</h5>
                <h5 class="modal-title text-white arabic" id="addRequestModalLabel">إضافة طلب </h5>
            ...
            <div class="modal-header bottom-border p-1">
                ...
                <h5 class="modal-title modal-heading text-black" id="addRequestModalLabel">Add Request &nbsp; / &nbsp;</h5>
                <h5 class="modal-title modal-heading text-black arabic" id="addRequestModalLabel">إضافة طلب </h5>
                <button type="button" class="close little-modalclose-btn p-1 px-2" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <div class="modal-body">
                <form id="addRequestForm" action="{{ route('request.managemant.store.requests') }}" method="POST">
                    <div class="form-row">
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" value="{{ $requets->count() + 1 }}" class="form-control"
                        ...
                        <div class="form-group col-md-4">
                            <div class="d-flex justify-content-between">
                                ...
                                <label for="" class="arabic red">
                                    نوع الطلب </label>
                            </div>

                            <select id="request_type_id" name="request_type_id" class="form-control">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="requestee_name" name="requestee_name">
                        </div>
                        <div class="form-group col-md-3">
                            <div class="d-flex justify-content-between">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" class="form-control" id="funds_requested" name="funds_requested"
                                placeholder="0.00">
                        </div>
                        <div class="form-group col-md-6">
                            <div class="d-flex justify-content-between">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-12 text-right">
                            ...
                            <textarea name="notes_arabic" type="text" class="form-control text-right" id="notes_arabic" cols="30"
                                rows="2"></textarea>
                        </div>
                    </div>
                    <div class="form-row">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn save-btn d-flex" id="addRequestBtn">
                    <p>Save &nbsp;/&nbsp;</p>
