                    ...
                    <div class="card m-b-30 border-0">
                        ...
                        <div class="row text-center profile-block">
                            <div class="col-6 align-self-center py-3 border-right">
                                <p class="profile-count">{{ $user->timelines()->count() }}</p>
                                <p class="mb-0">Job Entries</p>
                            </div>

                            <div class="col-6 align-self-center py-3 border-right">
                                <h5 class="text-employee-type mb-0">{{ $user->employee_type }}</h5>
                                <hr class="my-1">
                                <h5 class="text-employee-type">{{ $user->employee_sub_type }}</h5>
                            </div>
                ...
                <div class="col-lg-9 col-sm-12">
                    <div class="card-title tab-2">
                        ...
                        <div class="tab-content p-4 bg-white">
                                                                    ...
                                                                    <div class="col-12 col-md-7">
                                                                        ...
                                                                        <table class="table table-hover">
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <th>Date of Birth:</th>
                                                                                    <th>{{ Carbon\Carbon::parse($user->dob)->format('j F Y') }}
                                                                                    </th>
                                                                                </tr>
                                                                                <tr>
                                                                                    <th>Address:</th>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <th>
                                                                                        @if ($userSignature)
                                                                                            <img src="{{ $userSignature->file_url }}"
                                                                                                alt=""
                                                                                                class="img-fluid">
                                                                                            <div class="d-flex mt-2">
                                                                                                <a href="#"
                                                                                                    ...
                                                                                                    data-toggle="modal"
                                                                                                    data-target="#signatureUpdateModal">Update
                                                                                                    Signature</a>
                                                                                            </div>
                                                                                        @else
                                                                                            <a href="#"
                                                                                                ...
                                                                                                data-toggle="modal"
                                                                                                data-target="#signatureModal">Add
                                                                                                Signature</a>
                                                                                        @endif
                                                                                    </th>
                                                                                </tr>
                                                                        ...
                                                                        <table class="table table-hover">
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <th><a href="{{ route('users.edit.profile', ['id' => Auth::id()]) }}"
                                                                                            class="btn save-btn px-3">Edit</a>
                                                                                    </th>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                            ...
                            <!-- ========MODAL SIGNATURE============= -->
                            @include('admin.user_management.users._partials._signature')
                            @include('admin.user_management.users._partials._signatureUpdate')
