                        ...
                        <div class="row">
                            ...
                            @if (Auth::user()->can('Add Protocol and Liaison'))
                                <div class="col-4 text-right">
                                    <a href="{{ route('protocol-and-liaisons.create', ['module' => App\Models\ProtocolLiaison::PROPERTY]) }}"
    ...
    <script>
        var table = $('.ajax-table').DataTable({
            ...
            columns: [{
                ...
                {
                    data: 'property_google_map_lat',
                    name: 'property_google_map_lat'
                },
                {
                    data: 'property_google_map_lng',
                    name: 'property_google_map_lng'
                },
                {
                    data: 'action',
                    name: 'action',
