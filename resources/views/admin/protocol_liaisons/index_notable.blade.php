                        ...
                        <div class="row">
                            ...
                            @if (Auth::user()->can('Add Protocol and Liaison'))
                                <div class="col-4 text-right">
                                    <a href="{{ route('protocol-and-liaisons.create', ['module' => App\Models\ProtocolLiaison::NOTABLE]) }}"
    ...
    <script>
        var table = $('.ajax-table').DataTable({
            ...
            columns: [{
                ...
                {
                    data: 'notable_google_map_lat',
                    name: 'notable_google_map_lat'
                },
                {
                    data: 'notable_google_map_lng',
                    name: 'notable_google_map_lng'
                },
                {{--  {
                    data: 'status',
                    name: 'status'
                    ...
                    cooridnates.forEach((coordinate, i) => {
                        ...
                        google.maps.event.addListener(marker, 'click', (function(marker, i) {
                            return function() {
                                ...
                                <b>Designation:</b> ${coordinate.city}<br>
                                <div class="row">
                                    <div class="col-md-6">
