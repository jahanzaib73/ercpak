    ...
    <div class="container-fluid">
        <div class="page-head">
            <h4 class="mt-2 mb-2"><a
                    href="{{ route('protocol-liaison-teams.index', ['id' => $protocolLiaisonId]) }}">Members</a> / Update
                Team Member</h4>
        ...
        <form class="" method="post" action="{{ route('protocol-liaison-teams.update', ['id' => $teamMember]) }}"
                                ...
                                <div class="row mt-5">
                                    <div class="col-md-6">
                                        <h5 class="header-title pb-3">
                                            <img src="{{ $teamMember->photo_url }}" width="200" height="200"
                                                alt="">
                                        </h5>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" class="form-control"
                                                value="{{ old('name', $teamMember->name) }}" placeholder="Name" />
                                            @error('name')
                                                <span class="error">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="contact_number" class="form-control"
                                                value="{{ old('contact_number', $teamMember->contact_number) }}"
