                        ...
                        <div class="row">
                            ...
                            @if (Auth::user()->can('Add Protocol and Liaison'))
                                <div class="col-4 text-right">
                                    <a href="{{ route('protocol-and-liaisons.create', ['module' => App\Models\ProtocolLiaison::PROJECT]) }}"
    ...
    <script>
        var table = $('.ajax-table').DataTable({
            ...
            columns: [{
                ...
                {
                    data: 'project_google_map_lat',
                    name: 'project_google_map_lat'
                },
                {
                    data: 'project_google_map_lng',
                    name: 'project_google_map_lng'
                },
                {
                    data: 'action',
                    name: 'action',
