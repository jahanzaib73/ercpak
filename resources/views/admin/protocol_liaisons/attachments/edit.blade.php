...
@section('content')
    <div class="container-fluid">
        ...
        <form class="" method="post" action="{{ route('project-attachments.update', ['id' => $attachment->id]) }}"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" class="form-control"
                                                value="{{ $attachment->file_name }}" placeholder="Name" />
                                            @error('name')
                                                <span class="error">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="lat" class="form-control"
                                                value="{{ $attachment->lat }}" placeholder="lat" step=".0000000000000001" />
                                            @error('lat')
                                                <span class="error">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="lng" class="form-control"
                                                value="{{ $attachment->lng }}" placeholder="lng" step=".0000000000000001" />
                                            @error('lng')
                                                <span class="error">
                                                    <strong>{{ $message }}</strong>
                                                </span>
