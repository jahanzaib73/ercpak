<div class="modal fade" id="editInventory" aria-labelledby="editInventoryLabel" aria-hidden="true">
    <div class="modal-dialog modal-xxl">
        <div class="modal-content" style="width: 150%">
            {{-- <div class="modal-header bg-info">
                <h2 class="modal-title text-white" id="editInventoryLabel"><strong>Edit Inventory</strong></h2>
            ...
            <div class="modal-header bottom-border p-1">
                <h3 class="modal-title modal-heading text-black" id="exampleModalLabel"><strong>Edit Inventory</strong></h3>
                <button type="button" class="close little-modalclose-btn p-1 px-2" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <form id="inventory_update_form" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-row mb-2">
                        ...
                        <div class="form-group col-md-4 text-right">
                            <img width="180" height="100" id="blah" class="pb-1 inventory_image"
                                src="http://placehold.it/180" alt="your image" />
                            <input id="inventory_image_input" name="file" type='file' onchange="readURL(this);"
                                style="display: none" />
                        </div>
                    ...
                    <div class="form-row mb-2">
                        ...
                        <div class="form-group col-md-4 proeprty_container d-none">
                            ...
                            <select name="property_id" id="property_id" class="select2 form-control mb-3 custom-select"
                    ...
                    <div class="row mb-2 other_field">
                        ...
                        <div class="col-md-4">
                            {{-- <h6 for="description" class="light-dark">Item Name</h6> --}}
                    ...
                    <div class="row mb-2 other_field">
                        <div class="col-md-3">
                            ...
                            <select name="item_make_id" id="item_make_id"
                                class="select2 form-control mb-3 custom-select" style="width: 100%; height:36px;">
