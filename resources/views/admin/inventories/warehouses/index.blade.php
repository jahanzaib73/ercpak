@extends('layouts.app')
@section('warehouse-active-class', 'active')

@section('content')
    <div class="container-fluid mt-5">
        <div class="d-flex justify-content-between topbar-header rounded text-white p-2 mb-3">
            <div class="py-0 pl-3">
                <h3 class="mb-0 pt-1">List of Warehouse</h3>
            </div>

            @if (Auth::user()->can('Add Warehouses'))
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @if (Auth::user()->can('Delete Warehouses'))
                                    <a href="{{ route('warehouses.delete', ['id' => $type->id]) }}"
        ...
        <!-- Add Modal -->
        @include('admin.inventories.warehouses._models._add')

        <!-- Edit Modal -->
        @include('admin.inventories.warehouses._models._edit')
