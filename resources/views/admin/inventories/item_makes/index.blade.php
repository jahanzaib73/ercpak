@extends('layouts.app')
@section('item-make-active-class', 'active')

@section('content')
    <div class="container-fluid mt-5">
        <div class="d-flex justify-content-between topbar-header text-white p-2 mb-3" style="border-radius: 5px">
            <div class="py-0 pl-3">
                <h3 class="mb-0 pt-1">List of Item Makes</h3>
            </div>

            @if (Auth::user()->can('Add Item Make'))            
        ...
        <!-- Add Modal -->
        @include('admin.inventories.item_makes._models._add')

        <!-- Edit Modal -->
        @include('admin.inventories.item_makes._models._edit')
