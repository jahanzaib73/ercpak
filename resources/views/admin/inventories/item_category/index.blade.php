...
@section('content')
    <div class="container-fluid mt-5">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @if (Auth::user()->can('Delete Item Category'))
                                    <a href="{{ route('item.category.delete', ['id' => $type->id]) }}"
        ...
        <!-- Add Modal -->
        @include('admin.inventories.item_category._models._add')

        <!-- Edit Modal -->
        @include('admin.inventories.item_category._models._edit')
