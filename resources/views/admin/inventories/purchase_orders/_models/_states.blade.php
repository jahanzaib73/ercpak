<div class="row">
        ...
        <div class="card-content">
            ...
            <div class="card-body py-0">
                <div class="d-flex justify-content-between align-items-center">
                    <h6 class="card-title">Requisitions</h6>
                    <h4>{{ $totalRequsition }}</h4>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card col-12 col-md-6 col-lg-3">
        <div class="card-content">
            ...
            <div class="card-body py-0">
                <div class="d-flex justify-content-between align-items-center">
                    <h6 class="card-title">PO Open</h6>
                    <h4>{{ $totalPO }}</h4>
                </div>
            </div>
        </div>
    ...
    <div class="card col-12 col-md-6 col-lg-3">
        <div class="card-content">
            ...
            <div class="card-body py-0">
                <div class="d-flex justify-content-between align-items-center">
                    <h6 class="card-title">PO Closed</h6>
                    <h4>{{ $totalPOclosted }}</h4>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card col-12 col-md-6 col-lg-3">
        <div class="card-content">
            ...
            <div class="card-body py-0">
                <div class="d-flex justify-content-between align-items-center">
                    <h6 class="card-title">Comparatives</h6>
                    <h4>{{ $totalComparatve }}</h4>
                </div>
            </div>
        </div>
    </div>
