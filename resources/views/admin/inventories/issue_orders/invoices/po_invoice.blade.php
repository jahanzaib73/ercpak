            ...
            <div class="col-lg-12 col-sm-12">
                <div class="card m-b-30">
                    <form id="add_purchase_order_form">
                        ...
                        <input type="hidden" name="po_id" value="{{ $invoice->purchase_order_id }}">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="card">
                                        <tr>
                                            <div class="col-md-12 text-right">
                                                <p>PO#: {{ optional($invoice->purchaseOrder)->id }}</p>
                                                <p>Date: {{ $invoice->date }}</p>
                                            </div>
                                        </tr>
                                    </div>
                                                ...
                                                @foreach ($comparatives as $comparative)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php
                                                            $item = App\Models\IssueOrder::where('invoice_id', $invoice->id)
                                                                ->where('po_id', $invoice->purchase_order_id)
                                                                ->where('item_id', $comparative->item->id)
                                                                ->first();
                                                            
                                                            ?>

                                                            <input value="{{ optional($item)->issued_qty ?: 0 }}"
                                                                class="form-control received-quantity" type="number"
                                                                data-item-id="{{ $comparative->item->id }}"
                                                                name="item_{{ $comparative->item->id }}" />
