...
@section('content')
    <div class="container-fluid">
        <div class="page-head">
            <h4 class="mt-2 mb-2"><a href="{{ route('task-list.index', ['id' => $taskId]) }}">Task List</a> / Add List</h4>
        ...
        <form class="" method="post" action="{{ route('task-list.store') }}" enctype="multipart/form-data">
            @csrf
