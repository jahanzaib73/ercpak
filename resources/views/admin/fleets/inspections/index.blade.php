...
@section('content')
    <div class="container-fluid mt-5">
        ...
        <div class="d-flex justify-content-between rounded topbar-header  text-white p-2 mb-3">
            <div class="py-0 pl-3">
                <h3 class="mb-0 pt-1">List of Inspections</h3>
            </div>

            @if (Auth::user()->can('Add Inspection'))

            <a href="{{ route('inspections.create') }}"  class="btn mr-2 save-btn">Add
                Inspection</a>
            @endif
        </div>
