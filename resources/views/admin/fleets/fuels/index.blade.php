...
@section('content')
    <div class="container-fluid mt-5">
        @include('admin.fleets.fuels._models._state')
        ...
        @endphp
        <div class="d-flex align-items-center rounded justify-content-between topbar-header text-white p-2 px-3 mb-3"
            style="border-radius: 5px">
            <div>
                <h3 class="mb-0">Fuel Entries</h3>
            </div>

            @if (Auth::user()->can('Add Fuels Slip'))
                <button type="button" class="btn save-btn text-dark" data-toggle="modal" data-target="#addFuelLabel">Fuel Entry
                </button>
            @endif
        ...
        <!-- Add Modal -->
        @include('admin.fleets.fuels._models._add', [
