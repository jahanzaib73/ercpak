...
@section('content')
    <div class="container-fluid mt-5">
        ...
        {{--  <ul class="nav nav-tabs" role="tablist">
            <li class="nav-item">
                <a href="{{ route('inspections.index') }}" role="tab" data-toggle="tab" class="nav-link active">
                    <h4>Inspections</h4>
                </a>
            </li>
            <li class="nav-item">
        ...
        <div class="row d-flex topbar-header rounded text-white p-2 mb-3">
            <div class="col-md-5 py-0 pl-3">
                <h3 class="mb-0 pt-1">List of Work Orders</h3>
            </div>

            <div class="col-md-7 text-right">
                <a class="btn save-btn  filter-link activeFilterButton" data-type="-1" href="#">All</a>
                <a class="btn save-btn  filter-link" href="#" data-type="0">Open</a>
                <a class="btn save-btn  filter-link" href="#" data-type="2">Pending</a>
                <a class="btn save-btn mr-1 filter-link" href="#" data-type="1">Closed</a>
            </div>
