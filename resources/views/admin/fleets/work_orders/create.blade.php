        ...
        <div class="row">
            <div class="col-lg-12 col-sm-12">
                <div class="card m-b-30">
                    <div class="card-body">
                        <h3 class="header-title pb-3">Add Inspection</h3>
                        <form id="add_inspection_form">
                            ...
                            <div class="form-row vehcile-section d-none">
                                ...
                                <div>
                                    <img id="blah" class="vehile_image" src="{{ asset('img/lcb.jpg') }}"
                                        alt="your image" />
                                </div>
                            ...
                            <hr>
                            <div class="form-row">
                                <div class="form-group col-6 col-md-4 inputMtr d-none">
                            ...
                            <div class="form-row">
                                <div class="form-group col-12 col-md-6">
                                    {{-- <label for="inspection_bies">Inspection By <i title="Multiple technicians can be added"
                                            class="fa fa-info-circle"></i> </label> --}}
                                    <select id="inspection_bies" name="inspection_bies[]" class="form-control select2"
                                        multiple>
                                        <option value="">Inspection By</option>
                            ...
                            <hr>
                            <div class="d-flex justify-content-around w-100 py-5">

                                <button type="button" class="btn cancel-btn w-100">Cancel</button>

                                <button type="button" id="add_inspection_btn" class="btn save-btn w-100">Save</button>
