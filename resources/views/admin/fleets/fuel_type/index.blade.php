@extends('layouts.app')
@section('fuel-type-active-class', 'active')
...
@section('content')
    <div class="container-fluid mt-5">
        <div class="d-flex align-items-center justify-content-between topbar-header text-white p-2 px-3 mb-3" style="border-radius: 5px">
            <div>
                <h3 class="mb-0">List of Fuel Type</h3>
            </div>

            @if (Auth::user()->can('Add Fuel Type'))
        ...
        <!-- Add Modal -->
        @include('admin.fleets.fuel_type._models._add')

        <!-- Edit Modal -->
        @include('admin.fleets.fuel_type._models._edit')
