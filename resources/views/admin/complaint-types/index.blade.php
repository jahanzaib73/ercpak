...
@section('content')
    <div class="container-fluid">
        <div class="page-head">
            <h4 class="mt-2 mb-2">COMPLAINT TYPES</h4>
        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-sm-12">
                @if (Auth::user()->can('Add Complaint Type'))
                    <div class="card m-b-30">
                        <div class="card-body">
                            ...
                            <form role="form" method="POST"
                                action="{{ isset($data['complaintType']) ? route('complaint-types.update', ['id' => $data['complaintType']->id]) : route('complaint-types.store') }}">
                                @csrf
                                <div class="row">
                                    <div class="col-md-5">
                                        ...
                                        <tbody>
                                            @foreach ($data['complaintTypes'] as $type)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if (Auth::user()->can('Edit Complaint Type'))
                                                            <a class="btn bg-info btn-sm edit text-white_record text-white"
                                                                href="{{ route('complaint-types.index', ['id' => $type->id]) }}"><i
                                                        ...
                                                        @if (Auth::user()->can('Delete Complaint Type'))
                                                            ...
                                                            <a class="btn btn-danger btn-sm"
                                                                ...
                                                                href="{{ route('complaint-types.delete', ['id' => $type->id]) }}"><i
