                                                    ...
                                                    <form>
                                                        <div class="row d-flex justify-content-between">
                                                            <div class="form-group col-12 col-md-8">
                                                                <div>
                                                                    <h2>{{ optional($inspection->vehicle)->vehicle_number }}
                                                                    </h2>
                                                                    <h4>{{ optional(optional($inspection->vehicle)->model)->name }}
                                                                    </h4>
                                                                </div>
                                                                <hr>
                                                                <div class="row">
                                                                    <div class="form-group col-6 col-md-4">
                                                                        <h5>Meter</h5>
                                                                        <h4>{{ optional($inspection->vehicle)->current_meter_reading }}
                                                                        </h4>
                                                                    </div>
                                                                    <div class="form-group col-6 col-md-4">
                                                                        <h5>Date</h5>
                                                                    ...
                                                                    <div class="form-group col-12 col-md-4">
                                                                        <h5>Cost Center</h5>
                                                                        <h4>{{ optional($inspection->costCenter)->title }}
                                                                        </h4>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-12 col-md-4">
                                                                <img id="blah"
                                                                    src="{{ optional($inspection->vehicle)->image_url }}"
                                                            ...
                                                            @foreach ($inspection->inspectionBies as $inspectionBy)
                                                                <div class="text-center pt-3 col-3">
                                                                    <img id="blah" width="20%"
                                                                        src="{{ optional($inspectionBy->user)->profile_pic_url }}"
                                                                        alt="your image" class="rounded-circle" />
                                                                    <div>
                                                                        <p class="my-0">
                                                                            {{ optional($inspectionBy->user)->full_name }}
                                                                        </p>
                                                                        <p class="my-0">
                                                                ...
                                                                <table id="myTable" class=" table order-list">
                                                                    ...
                                                                    <tbody>
                                                                        @foreach ($inspection->inspectionChecklistItems as $items)
                                                                            <tr>
                                                                                <td class="col-5">
                                                                                    <p>{{ optional($items->inspectionItem)->name }}
                                                                                    </p>
                                                                                </td>
                                                                                <td class="col-2">
                                                                                    @if ($items->status == 'OK')
