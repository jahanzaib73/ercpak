...
@section('title', 'Show Trip Detail')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Trip # : {{ $trip->id }} @if ($trip->status == 0)
                    ...
                    <div>
                        @if ($trip->status == 0)
                            @if (Auth::user()->can('Close Trips'))
                                <button type="button" class="btn  btn-primary save-btn" id="tripcloseButton"
                                    data-bs-toggle="modal" data-bs-target="#tripclose"> Close Trip
                                </button>
                            @endif
                        @endif
                        @if (Auth::user()->can('Edit Trips'))
                            <button type="button" class="btn  btn-primary save-btn" id="editTripbtn" data-bs-toggle="modal"
                                data-bs-target="#editTripLabel"> Edit
                                Trip
                            </button>
                        @endif
                        ...
                        @if ($trip->status == 0)
                            @if (Auth::user()->can('Cancel Trips'))
                                <button type="button" class="btn  btn-primary save-btn" data-bs-toggle="modal"
                                    data-bs-target="#tripCancel">
                                    Cancel
                                    Trip
                                </button>
                            @endif
                            @if (Auth::user()->can('Delete Trips'))
                                <a href="{{ route('trips.delete', ['id' => $trip->id]) }}" class="btn save-btn btn-primary"
                        ...
                        @if (Auth::user()->can('Generate Trip Report'))
                            <a href="{{ route('trip.report', ['id' => $trip->id]) }}"
                                class="btn save-btn btn-primary">Generate
                                Report</a>
                        @endif
                    </div>
                </div>
                <div class="container-fluid p-5">
                                ...
                                <div class="col-6">
                                    <div class="d-flex justify-content-around pt-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="my-0">{{ optional(optional($trip->driver)->designation)->name }}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="d-flex justify-content-around pt-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="my-0">{{ optional(optional($trip->official)->designation)->name }}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card col-12 col-md-4">
                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    ...
                                    <div class="col-6">
                                        <p><strong>{{ Carbon\Carbon::parse($trip->exit_datetime_out)->toDateString() }}</strong>
                                        </p>
                                        <p><strong>{{ Carbon\Carbon::parse($trip->exit_datetime_out)->format('h:i A') }}</strong>
                                        </p>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <p><strong>{{ $trip->return_meetr_reading ? $trip->return_meetr_reading : 'N/A' }}</strong>
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card col-12 col-md-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="col-6">
                                        <p><strong>{{ optional($trip)->origin ? optional($trip)->origin : 'N/A' }}</strong>
                                        </p>
                                        <p><strong>{{ optional($trip)->destination ? optional($trip)->destination : 'N/A' }}</strong>
                                        </p>
                                        <p><strong>{{ $trip->return_meetr_reading ? $trip->return_meetr_reading - $trip->exit_meetr_reading . ' KMs' : 'N/A' }}</strong>
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 col-md-3">
                            @if (Auth::user()->can('View Report Attachment'))
                                <h5>Attachments</h5>
                                <a href="javascript:Void(0)" data-bs-toggle="modal" data-bs-target="#allAttachment"
                    ...
                    {{--  Trip Close  --}}
                    @include('new-admin.fleets.trips._models._close')

                    @include('new-admin.fleets.trips._models._all_attachments')

                    @include('new-admin.fleets.trips._models._cancelled')
                    {{--  Trip Edit  --}}
                    @include('new-admin.fleets.trips._models._edit', [
                        'locations' => $locations,
