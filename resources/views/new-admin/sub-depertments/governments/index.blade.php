        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Government</h4>
                </div>
                        ...
                        <tbody>
                            @foreach ($data['governments'] as $government)
                                <tr>
                                    ...
                                    <td><span class="badge badge-{{ $government->status == 1 ? 'success' : 'danger' }}">
                                    ...
                                    <td>
                                        @if (Auth::user()->can('Edit Government'))
                                            <a class="btn bg-info btn-sm edit text-white_record text-white"
                                                href="{{ route('government.index', ['id' => $government->id]) }}"><i data-feather="edit-2" ></i></a>
                                        @endif
                                        @if (Auth::user()->can('Delete Government'))
                                            |
                                            <a class="btn btn-danger btn-sm" onclick="return confirm('Are you sure?')"
                                                href="{{ route('government.delete', ['id' => $government->id]) }}"><i data-feather="trash" ></i></a>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
