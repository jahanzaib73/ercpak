<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
    <li class="nav-item mb-2" role="presentation">
        <button class="nav-link active btn btn-primary ms-2" id="pills-home-tab" data-toggle="pill"
            data-target="#pills-home" type="button" role="tab" aria-controls="pills-home"
            aria-selected="true">Pakistan <span id="pakistanCount"
                class="badge badge-info">{{ (array_key_exists('protocolLiaisons', $allData) ? count($allData['protocolLiaisons']) : 0) + (array_key_exists('customerVisits', $allData) ? count($allData['customerVisits']) : 0) }}</span></button>
    </li>
    <li class="nav-item mb-2" role="presentation">
        <button class="nav-link btn btn-primary ms-2" id="pills-profile-tab" data-toggle="pill"
            data-target="#pills-profile" data-name="baluchistan" type="button" role="tab"
            aria-controls="pills-profile" aria-selected="false">Baluchistan <span id="baluchistanCount"
                class="badge badge-info">{{ $baluchistanCount }}</span></button>
    </li>
    <li class="nav-item mb-2" role="presentation">
        <button class="nav-link btn btn-primary ms-2" id="pills-contact-tab" data-toggle="pill"
            data-target="#pills-contact" data-name="sindh" type="button" role="tab" aria-controls="pills-contact"
            aria-selected="false">Sindh <span id="sindhCount"
                class="badge badge-info">{{ $sindhCount }}</span></button>
    </li>
    <li class="nav-item mb-2" role="presentation">
        <button class="nav-link btn btn-primary ms-2" id="pills-contacts-tab" data-toggle="pill"
            data-target="#pills-contacts" data-name="punjab" type="button" role="tab"
            aria-controls="pills-contacts" aria-selected="false">Punjab <span id="punjabCount"
                class="badge badge-info">{{ $punjabCount }}</span></button>
    </li>
    <li class="nav-item mb-2" role="presentation">
        <button class="nav-link btn btn-primary ms-2" id="pills-contacta-tab" data-toggle="pill"
            data-target="#pills-contacta" data-name="khyber pk" type="button" role="tab"
            aria-controls="pills-contacta" aria-selected="false">Khyber
            PK <span id="kpkCount" class="badge badge-info">{{ $kpkCount }}</span></button>
    </li>
</ul>
<div class="tab-content" id="pills-tabContent">
    ...
    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
        <div class="row">
            <div class="col-12">
                <svg id="regional_map" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    viewBox="0 0 1628 1544" style="display: inline; height:70vh">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                        ...
                        <svg id="regional_map" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 500 1028 944"
                            style="display: inline; height:70vh">
    ...
    <div class="tab-pane fade" id="pills-contacts" role="tabpanel" aria-labelledby="pills-contacts-tab">
        <div class="row">
            <div class="col-12">
                <svg id="regional_map" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    viewBox="800 300 1028 1244" style="display: inline; height:70vh">
    ...
    <div class="tab-pane fade" id="pills-contacta" role="tabpanel" aria-labelledby="pills-contacta-tab">
        <div class="row">
            <div class="col-12">
                <svg id="regional_map" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    viewBox="600 0 828 744" style="display: inline; height:70vh">
