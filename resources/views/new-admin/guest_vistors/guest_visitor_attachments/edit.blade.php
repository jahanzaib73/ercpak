...
@section('title', 'Update Attachements')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Update Attachements</h4>
                </div>
                        ...
                        <div class="card m-b-30">
                            <div class="card-body">
                                <form class="form form-horizontal" method="POST" enctype="multipart/form-data"
                                    action="{{ route('guest-visitor-attachment.update', ['id' => $attachment->id]) }}">
                                    @csrf
                                    <input type="hidden" name="guestVisitId" value="{{ $attachment->guest_visitor_id }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="mb-1">
                                                ...
                                                <!-- Changed type to "date" to match the create form -->
                                                <input type="date" name="expiary_date" class="form-control"
                                                    value="{{ old('expiary_date', $attachment->expiary_date) }}"
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="mb-1">
                                                ...
                                                <input type="text" name="name" class="form-control"
                                                    value="{{ old('name', $attachment->file_name) }}" placeholder="Name">
                                                @error('name')
                                                    <span class="error">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                            ...
                                            <div class="mb-1">
                                                ...
                                                <select name="status" id="status" class="form-control">
                                                    ...
                                                    <option value="Pending"
                                                        {{ $attachment->status == 'Pending' ? 'selected' : '' }}>
                                                        Pending
                                                    </option>
                                                    <option value="Accepted"
                                                        {{ $attachment->status == 'Accepted' ? 'selected' : '' }}>
                                                        Accepted
                                                    </option>
                                                    <option value="Cancelled"
                                                        {{ $attachment->status == 'Cancelled' ? 'selected' : '' }}>
                                                        Cancelled
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-12 col-12">
                                            <div class="mb-1">
                                                ...
                                                <textarea name="notes" id="notes" class="form-control" cols="30" rows="3">{{ old('notes', $attachment->notes) }}</textarea>
                                                @error('notes')
                                                    <span class="error">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
