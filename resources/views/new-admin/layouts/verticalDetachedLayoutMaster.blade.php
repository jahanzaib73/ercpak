...
data-asset-path="{{ asset('/')}}">
  ...
  @include('new-admin.panels.sidebar')
  @endif
  ...
  <div class="app-content content {{ $configData['pageClass'] }}">
    ...
    <div class="content-wrapper {{ $configData['layoutWidth'] === 'boxed' ? 'container-xxl p-0' : '' }}">
      {{-- Include Breadcrumb --}}
      @if($configData['pageHeader'] == true) @include('new-admin.panels.breadcrumb') @endif
  ...
  @if($configData['blankPage'] == false) @include('new-admin/content/pages/customizer') @include('content/pages/buy-now') @endif
