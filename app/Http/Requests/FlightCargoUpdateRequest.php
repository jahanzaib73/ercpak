...
class FlightCargoUpdateRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'flight_number' => ['required_if:air_type,1'],
            'flight_type_id' => ['required_if:air_type,1'],
            'aircraft_vessel_id' => ['required_if:air_type,1'],
            'flight_belongs_to' => ['required_if:air_type,1'],
            ...
            'sea_vessel_number' => ['required_if:sea_type,2'],
            'sea_vessel_type' => ['required_if:sea_type,2'],
            'sea_arrival_origin' => ['required_if:sea_type,2'],
            'sea_arrival_date_time' => ['required_if:sea_type,2'],
            'sea_destination' => ['required_if:sea_type,2'],
            'sea_destination_date_time' => ['required_if:sea_type,2'],
            'cargo_belongs_to' => ['required_if:sea_type,2'],
            // 'cargo_notes' => ['required_if:sea_type,2'],
            // 'sea_notes' => ['required_if:sea_type,2'],
            // 'is_sea_cargo_vehicles' => ['required_if:sea_type,2'],
            'number_of_vehicle' => ['required_if:is_sea_cargo_vehicles,on'],
            // 'sea_vehicle_attachment' => ['required_if:is_sea_cargo_vehicles,on'],
            // 'is_sea_cargo' => ['required_if:sea_type,2'],
            'weight_of_cargo' => ['required_if:is_sea_cargo,on'],
            // 'sea_cargo_attachment' => ['required_if:is_sea_cargo,on'],
            // 'is_sea_cargo_other' => ['required_if:sea_type,2'],
            'sea_cargo_other_details' => ['required_if:is_sea_cargo_other,on'],
            // 'sea_cargo_other_attachment' => ['required_if:is_sea_cargo_other,on'],

            'road_arrival_origin' => ['required_if:road_type,3'],
            'road_arrival_date_time' => ['required_if:road_type,3'],
            'road_destination' => ['required_if:road_type,3'],
            'road_destination_date_time' => ['required_if:road_type,3'],
            'road_cargo_belongs_to' => ['required_if:road_type,3'],
            // 'road_notes' => ['required_if:road_type,3'],
            'road_type_of_cargo' => ['required_if:road_type,3'],
            // 'road_cargo_list_attachments' => [
            //     Rule::requiredIf(function() {
            //         return !empty($this->request->get('road_list_of_cargo'));
            //     })
            // ],
            // 'road_driver_name' => ['required_if:road_type,3'],
            // 'road_driver_number' => ['required_if:road_type,3'],
            // 'road_vehicle_number_type' => ['required_if:road_type,3'],
        ];
    }
